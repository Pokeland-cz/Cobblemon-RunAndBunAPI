...
public final class CTEngineOld {
    ...
    //             Path winRegistryPath = Paths.get(CTEngineOld.runServer.getSavePath(WorldSavePath.PLAYERDATA).getParent().toString(),
    ...
    //     EnvExecutor.runInEnv(Env.CLIENT, () -> CTEngineOld.Client::initializeClient);
    // }
